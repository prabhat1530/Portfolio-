...
export default function Contact() {
  ...
  // IMPORTANT: To make this contact form fully automatic without opening the mail app:
  // 1. Go to https://web3forms.com/ and submit your email (pk9588934@gmail.com)
  // 2. You will get a free access key in your email.
  // 3. Paste that key below.
  const WEB3FORMS_ACCESS_KEY = "2dee7ed6-7f0b-4c3f-844f-f737aa3c5eae"; 
        ...
        <div className="contact-wrapper">
          ...
          >
            ...
            >
              <div className="contact-detail" data-cursor-hover>
                ...
                <div>
                  ...
                  <div className="contact-detail-value">pk9588934@gmail.com</div>
                </div>
              </div>
              <div className="contact-detail" data-cursor-hover>
                <div className="contact-detail-icon">📱</div>
            ...
            <div className="contact-socials">
              ...
              <a href="mailto:pk9588934@gmail.com" className="contact-social" data-cursor-hover aria-label="Email">
          ...
          >
            <form className="contact-form" onSubmit={handleSubmit}>
              ...
              <button
                ref={submitRef}
                type="submit"
                className={`form-submit ${submitStatus}`}
